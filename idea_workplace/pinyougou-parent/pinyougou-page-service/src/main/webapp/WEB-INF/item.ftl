				...
				<div class="fl preview-wrap">
					...
					<div class="zoom">
						...
						<div id="preview" class="spec-preview">
							<span class="jqzoom">
								<#if (imageList?size>0)>
								<img jqimg="${imageList[0].url}" src="img/_/s1.png" width="400px" height="400px"/>
								</#if>
							</span>
						</div>
						<!--下方的缩略图-->
...
购热销商品</em>
					...
					<div class="clearfix choose">
						<div id="specification" class="summary-wrap clearfix">
							<#list specificationList as specList>
							<dl>
								<dt>
									<div class="fl title">
									<i>${specList.attributeName}</i>
								</div>
								</dt>
								<#list specList.attributeValue as value>
								<dd><a class="{{isSelected('${specification.attributeName}','${item}')?'selected':''}}"  ng-click="selectSpecification('${specification.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span></a></dd>
								</#list>
						...
						<div class="tab-content tab-wraped">
							<div id="one" class="tab-pane active">
								<ul class="goods-intro unstyled">
									<#list customAttributeList as CAL >
										<#if item.value??>
									<li>${CAL.text}:${CAL.value}</li>
										</#if>
									</#list>
								</ul>
